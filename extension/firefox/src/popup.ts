/**
 * Popup (Firefox build): recent events and connection status.
 * Identical behavior to the Chromium popup; kept separate because the
 * build outputs differ per browser.
 */
